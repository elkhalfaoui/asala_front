...
const Header = () => {
  ...
  return (
    ...
    >
      <div className="md:container mx-auto h-full md:px-4 flex justify-between items-center md:grid md:grid-cols-4 lg:grid-cols-3">
        <menu className="col-span-1 w-full h-full flex md:flex-row justify-between items-center px-4 md:p-0 bg-white">
          ...
          <Link href="/" className="flex items-center gap-1">
            <Image src='/ASALA DESIGN 1.png' alt='ASALA DESIGN' width={120} height={32} />
          </Link>
        ...
        <nav
          className={`md:col-span-3 lg:col-span-2 flex justify-between items-center flex-col md:flex-row h-[calc(100dvh-64px)] py-16 md:py-0 absolute left-0 w-full md:h-fit md:translate-0 md:top-0 md:relative duration-500 -z-10 md:z-0 bg-white ${
